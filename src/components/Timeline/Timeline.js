...
const Timeline = ({ onChange, changeColumn, data }) => {
    ...
    const [border, setBorder] = useState(['solid', 'hidden', 'hidden', 'hidden'])
                    ...
                    <div style={{ justifyContent: 'flex-start', display: 'flex', margin: 0, padding: 0 }}>
                        {
                            isMobile
                                ...
                                // Card of Meilstone
                                <>
                                    <Card style={{ width: diff_mobile[3], height: 50, display: 'flex', alignItems: 'center', position: 'absolute', left: start_point_mobile[3], borderLeft: border[3], borderLeftWidth: '4px' }} onClick={() => { onChange(3); changeColumn(); setBorder(['hidden', 'hidden', 'hidden', 'solid']) }}>
                                        <p style={{ margin: 0 }}>
                                            {(() => {
                                    ...
                                    <Card style={{ width: diff_mobile[2], height: 50, display: 'flex', alignItems: 'center', position: 'absolute', left: start_point_mobile[2], borderLeft: border[2], borderLeftWidth: '4px' }} onClick={() => { onChange(2); changeColumn(); setBorder(['hidden', 'hidden', 'solid', 'hidden']) }}>
                                        <p style={{ margin: 0 }}>
                                            {(() => {
                                    ...
                                    <Card style={{ width: diff_mobile[1], height: 50, display: 'flex', alignItems: 'center', position: 'absolute', left: start_point_mobile[1], borderLeft: border[1], borderLeftWidth: '4px' }} onClick={() => { onChange(1); changeColumn(); setBorder(['hidden', 'solid', 'hidden', 'hidden']) }}>
                                        <p style={{ margin: 0 }}>
                                            {(() => {
                                    ...
                                    <Card style={{ width: diff_mobile[0], height: 50, display: 'flex', alignItems: 'center', position: 'absolute', left: start_point_mobile[0], borderLeft: border[0], borderLeftWidth: '4px' }} onClick={() => { onChange(0); changeColumn(); setBorder(['solid', 'hidden', 'hidden', 'hidden']) }}>
                                        <p style={{ margin: 0 }}>
                                            {(() => {
                    ...
                    <div style={{ justifyContent: 'flex-start', display: 'flex', margin: 0, padding: 0 }}>
                        {
                            isMobile
                                ...
                                :
                                <>
                                    <Card style={{ width: diff[3], height: 50, display: 'flex', alignItems: 'center', position: 'absolute', left: start_point[3], borderLeft: border[3], borderLeftWidth: '4px' }} onClick={() => { onChange(3); changeColumn(); setBorder(['hidden', 'hidden', 'hidden', 'solid']) }}>
                                        <p style={{ margin: 0 }}>
                                            {(() => {
                                                switch (data[3].status) {
                                                    case 1:
                                    ...
                                    <Card style={{ width: diff[2], height: 50, display: 'flex', alignItems: 'center', position: 'absolute', left: start_point[2], borderLeft: border[2], borderLeftWidth: '4px' }} onClick={() => { onChange(2); changeColumn(); setBorder(['hidden', 'hidden', 'solid', 'hidden']) }}>
                                        <p style={{ margin: 0 }}>
                                            {(() => {
                                                switch (data[2].status) {
                                                    case 1:
                                    ...
                                    <Card style={{ width: diff[1], height: 50, display: 'flex', alignItems: 'center', position: 'absolute', left: start_point[1], borderLeft: border[1], borderLeftWidth: '4px' }} onClick={() => { onChange(1); changeColumn(); setBorder(['hidden', 'solid', 'hidden', 'hidden']) }}>
                                        <p style={{ margin: 0 }}>
                                            {(() => {
                                                switch (data[1].status) {
                                                    case 1:
                                    ...
                                    <Card style={{ width: diff[0], height: 50, display: 'flex', alignItems: 'center', position: 'absolute', left: start_point[0], borderLeft: border[0], borderLeftWidth: '4px' }} onClick={() => { onChange(0); changeColumn(); setBorder(['solid', 'hidden', 'hidden', 'hidden']) }}>
                                        <p style={{ margin: 0 }}>
                                            {(() => {
                                                switch (data[0].status) {
                                                    case 1:
